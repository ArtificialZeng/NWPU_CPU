...
dataRoot = '/home/dhqt/NWPU-Crowd-Sample-Code-master_junbo'
...
model_path = '/home/dhqt/NWPU-Crowd-Sample-Code-master_junbo/SFCN+-all_ep_321_mae_90.7_mse_487.2_nae_0.375.pth'
...
def test(file_list, model_path):
    ...
    net.load_state_dict(torch.load(model_path,map_location='cpu'),False)
